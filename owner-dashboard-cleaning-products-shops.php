        ...
        <div class="row">
            ...
            if (!empty($shops)) {
                ...
                foreach ($shops as $row) {
                    ...
                    echo '<a href="owner-dashboard-inventory-cleaning-products.php?shop_id=' . htmlspecialchars($row['shop_id']) . '" class="edit-shop-btn">';
                    echo '<i class="fas fa-edit me-2"></i>Edit Shop Inventory';
                    echo '</a>';
