                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="firstname" name="firstname" 
                                    placeholder="Edit your First Name" value="<?php echo $userData['firstname']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="contact"><i class="fas fa-phone"></i>Phone Number</label>
                                <input type="text" class="form-control" id="contact" name="contact" 
                                    placeholder="Edit your Contact" value="<?php echo $userData['contact']; ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lastname" name="lastname" 
                                    placeholder="Edit your Last Name" value="<?php echo $userData['lastname']; ?>">
                            </div>

                            <div class="form-group">
                                <label for="email"><i class="fas fa-envelope"></i>Email</label>
                                <input type="email" class="form-control" id="email" name="email" 
                                    placeholder="Edit your Email" value="<?php echo $userData['email']; ?>">
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="street_address" name="street_address" 
                                        placeholder="Edit your Complete Address"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="barangay" name="barangay" 
                                        placeholder="Edit your Barangay"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="province" name="province" 
                                        placeholder="Edit your Province"
